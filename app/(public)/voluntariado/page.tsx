...
export default function Voluntariado() {
  const { formData, status, setStatus, updateField, handleSubmit } = useFormHandler({
    ...
    onSuccess: () => {
      // Data reset is handled by the component on success if needed,
      // but the hook can also be used to reset.
    },
  });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-primary/5 to-white relative">
      ...
      <Hero
        ...
        subtitle="Tu tiempo, tu talento y tu corazón pueden transformar vidas. Sé parte del cambio en tu comunidad."
      />
