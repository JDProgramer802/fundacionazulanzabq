  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-secondary font-primary">Nueva Noticia</h1>
          <p className="text-gray-500">Crea una nueva publicación</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="Un pequeño resumen para la lista de noticias..."
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="Escribe aquí toda la historia..."
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="published" className="text-sm font-medium text-gray-700">Publicar inmediatamente</label>
        </div>
