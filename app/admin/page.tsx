...
export default async function AdminDashboard() {
  ...
  const cards = [
    ...
    {
      label: 'Voluntarios Nuevos',
      value: stats.volunteersPending,
      icon: Users,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 flex flex-col justify-center items-center text-center space-y-4">
          ...
          <p className="text-gray-500 max-w-xs">
            Gestiona tus citas y mensajes desde el menú lateral para mantener al día la labor de la
            fundación.
          </p>
