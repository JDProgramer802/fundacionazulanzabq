...
async function main() {
  ...
  const defaultSettings = [
    { key: 'site_title', value: 'Fundación Azulanza' },
    {
      ...
      value:
        'Fundación Azulanza brinda asistencia integral en salud mental, seguridad alimentaria y desarrollo comunitario.',
    },
    {
      key: 'global_description',
      value: 'Asistencia integral en salud mental y apoyo comunitario.',
    },
    ...
    { key: 'home_hero_title', value: 'Sanando Corazones, Construyendo Futuros' },
    {
      ...
      value: 'Brindamos apoyo emocional y herramientas para el bienestar de nuestra comunidad.',
    },
    {
      key: 'mission_text',
      value: 'Nuestra misión es transformar vidas a través del apoyo psicológico y social.',
    },
    { key: 'vision_text', value: 'Ser referentes en salud mental comunitaria en toda la región.' },
    {
      key: 'history_text',
      value: 'Fundación Azulanza nació del deseo de ayudar a quienes más lo necesitan...',
    },
  ];
