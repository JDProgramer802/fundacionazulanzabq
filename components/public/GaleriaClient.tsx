...
import { ImageIcon, Maximize2, X, ChevronLeft, ChevronRight, Camera } from 'lucide-react';
    ...
    <main className="min-h-screen bg-white pt-32 pb-20">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          >
            <Camera size={14} /> Momentos Azulanza BQ
          </motion.div>
          <motion.h1
          ...
          >
            Capturando la esencia de nuestra labor y el impacto en cada corazón que tocamos en
            Barranquilla.
          </motion.p>
        </div>
              ...
              <AnimatePresence mode="popLayout">
                {filteredItems.map((item, index) => (
                  ...
                  >
                    <Image
                      src={item.image_url}
                      alt={item.title || 'Galería Fundación Azulanza BQ'}
                      fill
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-secondary/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                      ...
                      <h3 className="text-white font-bold text-xl">
                        {item.title || 'Fundación Azulanza BQ'}
                      </h3>
                  ...
                  <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-full max-w-xl px-4">
                    <div className="glass-premium p-8 rounded-[2.5rem] text-center border-white/20">
                      ...
                      <h2 className="text-secondary font-bold text-2xl mb-2">
                        {filteredItems[selectedImage].title || 'Fundación Azulanza BQ'}
                      </h2>
